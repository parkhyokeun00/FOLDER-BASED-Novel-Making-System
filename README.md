...
- `MIDFORM_CASE_EXPANSION_GUIDE.md`
- `LIVING_AUTHOR_STYLE_BYPASS_PROTOCOL.md`
- `CONTAMINATED_EVIDENCE_PATTERN.md`
- `NARRATOR_MOTIVE_EARLY_CHECK.md`
- `TRAUMA_AWARE_CHARACTER_STATE_PROTOCOL.md`
- `CHAPTER_PACKET_PROTOCOL.md`
- `PRE_CHAPTER_SYNC_GATE.md`
- `CHAPTER_EXTENSION_GATE.md`
- `CHAPTER_ACCEPTANCE_GATE.md`
- `CHAPTER_ENDING_RHYTHM_CHECK.md`
